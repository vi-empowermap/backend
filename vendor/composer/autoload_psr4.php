...
return array(
    ...
    'Kirby\\' => array($vendorDir . '/getkirby/cli/src', $vendorDir . '/getkirby/cli/tests', $baseDir . '/kirby/src', $vendorDir . '/getkirby/composer-installer/src', $baseDir . '/site/plugins/kql/tests'),
