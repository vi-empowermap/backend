...
return array(
    ...
    'Kirby\\' => array($baseDir . '/kirby/src', $vendorDir . '/getkirby/composer-installer/src', $baseDir . '/site/plugins/kql/tests', $vendorDir . '/getkirby/cli/src', $vendorDir . '/getkirby/cli/tests'),
